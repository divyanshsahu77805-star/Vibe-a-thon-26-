...
const ScientistDetail = ({ scientist }: ScientistDetailProps) => {
  ...
  return (
    <motion.div
      className="relative animate-book-open"
    ...
    >
      {/* Book cover frame */}
      <div
        className="rounded-lg shadow-2xl overflow-hidden border-2"
        style={{
          borderColor: "hsl(var(--leather-light))",
          background: "hsl(var(--paper))",
          boxShadow: "8px 8px 30px rgba(0,0,0,0.2), -2px -2px 10px rgba(0,0,0,0.05)",
        }}
      >
